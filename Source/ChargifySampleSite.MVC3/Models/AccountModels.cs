...
namespace ChargifySampleSite.MVC3.Models
{
    ...
    public class AccountRoleService : IRoleService
    {
        ...
        {
            if (userNames.Count() <= 0) throw new ArgumentException("Value cannot be null or empty.", "userNames");
            if (roleNames.Count() <= 0) throw new ArgumentException("Value cannot be null or empty.", "roleNames");
    ...
    public interface IMembershipService
    {
        ...
        MembershipUser CreateUser(string userName, string password, string email, string question, string answer, out MembershipCreateStatus status);
    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        public MembershipUser GetUser(string userName)
        {
            ...
            try
            {
                MembershipUser theUser = _provider.GetUser(userName, false);
                return theUser;
            } catch {
                return null;
            }
        ...
        public MembershipUser GetUser()
        {
            try
            {
                MembershipUser theUser = _provider.GetUser(HttpContext.Current.User.Identity.Name, false);
                return theUser;
            }
            catch
            {
